...
conceptosService: ConceptosService;
  ...
  columns: ColumnConfig[] = [
    ...
    { field: 'publicaciones_relacionadas_ids', headerText: 'Nº Pub Rel.', width: 120, textAlign: 'Center' },
  ...
  formFields: FormFieldConfig[] = [
    ...
    { name: 'keywords', label: 'Keywords', type: 'text', placeholder: 'sepáralas por comas' },
    {
